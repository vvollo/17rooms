...
obj {
	...
	description = function(s)
		...
		if _'room2_s'.pl_high == 0 then
			if here() ^ "room2_terassa" then
				_txt = "Красивый, широколистный плющ, опутавший всю террасу. С виду — обычный Hedéra hélix." .. _study .. " Но тебя настораживает красноватый отлив с нижней стороны его листьев.";

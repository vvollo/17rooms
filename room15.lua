...
obj {
	...
	after_Consult = function(s, o)
		if not _'room15_bedroom'.awake and not o then
			pr 'О чём конкретно ты хочешь почитать?';
		elseif not _'room15_bedroom'.awake and (o:find("пусто") or o:find("ничем") or o:find("ничт") or o:find("ничём") or o:find("ритуал") or o:find("портал")) then
			pr [[
